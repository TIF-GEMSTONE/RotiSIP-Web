...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2018 at 07:24 AM
...
(70001, 'Roti Pisang', 0, 3000, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP/master/images/rotipisang.jpg'),
(70002, 'Roti Keju', 0, 3500, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP/master/images/rotikeju.jpg'),
(70003, 'Roti Coklat', 0, 3500, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP/master/images/roticoklat.jpg'),
(70004, 'Roti Sisir', 0, 8000, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP/master/images/rotisisir.jpg'),
(70005, 'Roti Kenong', 0, 9000, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP/master/images/rotikenong.jpg'),
(70006, 'Roti Sobek', 0, 8500, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP/master/images/rotisobek.jpg'),
(70007, 'Roti Tawar', 0, 10000, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP/master/images/rotitawar.jpg'),
(70009, 'Roti Strawberry', 0, 2000, 'https://raw.githubusercontent.com/TIF-GEMSTONE/RotiSIP-Web/master/assets/images/rotistrw.jpg'),
(70010, 'Roti Maryam', 0, 3500, 'cetak.PNG');
...
(80005, 'Ahmad Saifullah', 'Jl. Batu raden no.57', '083864576443', 'saiful', '12345'),
(80006, 'Warda Novitasari', 'Arjasa', '0812345678', 'warda', '12345');
...
--
ALTER TABLE `tabel_stok_sales`
  MODIFY `id_stok_sales` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12014;
--
-- AUTO_INCREMENT for table `tabel_transaksi_sales`
--
ALTER TABLE `tabel_transaksi_sales`
...
ALTER TABLE `tabel_pesanan`
  ...
  ADD CONSTRAINT `tabel_pesanan_ibfk_3` FOREIGN KEY (`id_roti`) REFERENCES `tabel_roti` (`id_roti`);
